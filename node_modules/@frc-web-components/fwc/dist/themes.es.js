class r {
  constructor(t = "data-theme") {
    this.themeSheets = {}, this.themeAttribute = t;
  }
  static createSheet() {
  ...
  addThemeRules(t, o) {
    typeof this.themeSheets[t] > "u" && (this.themeSheets[t] = r.createSheet());
    const c = Object.entries(o).map(
      ([e, l]) => `${e}: ${l};`
    );
    this.themeSheets[t].insertRule(`
      [${this.themeAttribute}="${t}"] {
        ${c.join(`
`)}
      }
    `);
  ...
  setTheme(t, o) {
    t.setAttribute(this.themeAttribute, o);
  }
  getTheme(t) {
    return t.getAttribute(this.themeAttribute) ?? void 0;
  }
}
const a = {
  /* Base (background) */
