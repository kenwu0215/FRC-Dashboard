...
K.prototype = Dt.prototype = {
  ...
  on: function(t, n) {
    ...
    if (arguments.length < 2) {
      for (; ++o < s; ) if ((i = (t = r[o]).type) && (i = dn(e[i], t.name))) return i;
      return;
    }
    if (n != null && typeof n != "function") throw new Error("invalid callback: " + n);
    for (; ++o < s; )
      if (i = (t = r[o]).type) e[i] = bt(e[i], t.name, n);
      else if (n == null) for (i in e) e[i] = bt(e[i], t.name, null);
    return this;
  },
  copy: function() {
    var t = {}, n = this._;
...
function Le(t, n, e) {
  ...
  for (a = n ? Oe : Pe, i = 0; i < o; ++i) this.each(a(r[i], n, e));
  return this;
}
function Wt(t, n, e) {
...
function Zt(t) {
  ...
  if (t instanceof V || (t = P(t)), !t) return new w();
...
gt(w, ir, Qt(V, {
  ...
  clamp() {
    return new w(Rt(this.h), z(this.s), z(this.l), Z(this.opacity));
  },
  displayable() {
...
function ar(t) {
  return (t = +t) == 1 ? tn : function(n, e) {
    return e - n ? sr(n, e, t) : jt(isNaN(n) ? e : n);
  };
}
function tn(t, n) {
  var e = n - t;
...
function en(t, n, e, r) {
  ...
  return function(f, l) {
    ...
    return f = t(f), l = t(l), o(f.translateX, f.translateY, l.translateX, l.translateY, c, h), s(f.rotate, l.rotate, c, h), a(f.skewX, l.skewX, c, h), u(f.scaleX, f.scaleY, l.scaleX, l.scaleY, c, h), f = l = null, function(p) {
      for (var d = -1, _ = h.length, $; ++d < _; ) c[($ = h[d]).i] = $.x(p);
      return c.join("");
    };
  };
}
var pr = en(cr, "px, ", "px)", "deg)"), dr = en(hr, ", ", ")", ")"), R = 0, F = 0, I = 0, rn = 1e3, j, H, tt = 0, S = 0, rt = 0, O = typeof performance == "object" && performance.now ? performance : Date, on = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function yt() {
...
nt.prototype = sn.prototype = {
  ...
  restart: function(t, n, e) {
    ...
    e = (e == null ? yt() : +e) + (n == null ? 0 : +n), !this._next && H !== this && (H ? H._next = this : j = this, H = this), this._call = t, this._time = e, ct();
  },
  stop: function() {
...
function ct(t) {
  if (!R) {
    F && (F = clearTimeout(F));
    var n = t - S;
    n > 24 ? (t < 1 / 0 && (F = setTimeout(Ft, t - O.now() - rt)), I && (I = clearInterval(I))) : (I || (tt = O.now(), I = setInterval(yr, rn)), R = 1, on(Ft));
  }
}
function Ht(t, n, e) {
  var r = new nt();
...
var xr = Dt("start", "end", "cancel", "interrupt"), vr = [], an = 0, qt = 1, ht = 2, G = 3, Xt = 4, pt = 5, W = 6;
...
function wt(t, n) {
  var e = x(t, n);
  if (e.state > an) throw new Error("too late; already scheduled");
  return e;
}
function m(t, n) {
  var e = x(t, n);
...
function mr(t, n, e) {
  ...
  function s(f) {
    var l, c, h, p;
    if (e.state !== qt) return u();
    for (l in r)
      if (p = r[l], p.name === e.name) {
        if (p.state === G) return Ht(s);
...
function un(t, n) {
  var e;
  return (typeof n == "number" ? A : n instanceof P ? Mt : (e = P(n)) ? (n = e, Mt) : lr)(t, n);
}
function Er(t) {
  return function() {
    this.removeAttribute(t);
...
function Ir(t, n) {
  ...
  return this.attrTween(t, typeof n == "function" ? (e.local ? Mr : Rr)(e, r, xt(this, "attr." + t, n)) : n == null ? (e.local ? Sr : Er)(e) : (e.local ? Tr : Cr)(e, r, n));
}
function Fr(t, n) {
  return function(e) {
...
function Dr(t, n) {
  ...
  var r = et(t);
  return this.tween(e, (r.local ? qr : Xr)(r, n));
}
function Pr(t, n) {
  return function() {
...
function li(t, n, e) {
  ...
  return n == null ? this.styleTween(t, si(t, r)).on("end.style." + t, fn(t)) : typeof n == "function" ? this.styleTween(t, ui(t, r, xt(this, "style." + t, n))).each(fi(this._id, t)) : this.styleTween(t, ai(t, r, n), e).on("end.style." + t, null);
}
function ci(t, n, e) {
  return function(r) {
...
function gi(t) {
  return this.tween("text", typeof t == "function" ? _i(xt(this, "text", t)) : di(t == null ? "" : t + ""));
}
function yi(t) {
  return function(n) {
...
function ki(t) {
  var n, e;
  t instanceof N ? (n = t._id, t = t._name) : (n = ln(), (e = Ai).time = yt(), t = t == null ? null : t + "");
